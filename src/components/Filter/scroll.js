class SimpleBar {
  ...
  calculateWidthsAndHeights() {
    ...
    this.childViewHeight =
      this.fixedChildHeight === undefined
        ? this.childViewElement.offsetHeight
        : this.fixedChildHeight;
  ...
  scrollToTickerY(tickerPosition) {
    ...
    tickerPosition =
      tickerPosition > this.viewHeight ? this.viewHeight : tickerPosition;
    ...
    this.onScrolled(
      lengthViewShouldMove,
      lengthViewShouldMove + this.viewHeight
    );
  }
}
